# janitor ![](reference/figures/logo_small.png)
...
- create and format frequency tables of one, two, or three variables -
  think an improved [`table()`](https://rdrr.io/r/base/table.html); and
...
which provides a summary of differences in column names and types when
given a set of data.frames.
...
[`make_clean_names()`](https://sfirke.github.io/janitor/reference/make_clean_names.md)
that can be used for piped data.frame workflows. The equivalent steps
with
[`clean_names()`](https://sfirke.github.io/janitor/reference/clean_names.md)
would be:
...
to identify and examine duplicate records during data cleaning. Let’s
see if any teachers are listed more than once:
...
with [`tabyl()`](https://sfirke.github.io/janitor/reference/tabyl.md).
...
Like [`table()`](https://rdrr.io/r/base/table.html), but pipe-able,
data.frame-based, and fully featured.

[`tabyl()`](https://sfirke.github.io/janitor/reference/tabyl.md) can be
called two ways:
...
[`knitr::kable()`](https://rdrr.io/pkg/knitr/man/kable.html) in your
RMarkdown report.
...
about [`tabyl()`](https://sfirke.github.io/janitor/reference/tabyl.md)
and the `adorn_` functions from the [tabyls
...
- compose a friendly e-mail to: ![samuel.firke AT
  gmail](https://samfirke.com/wp-content/uploads/2016/07/email_address_whitespace_top.png)
